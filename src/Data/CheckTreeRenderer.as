package Data
{
	...
	{   
		...
		static private var STATE_SCHRODINGER:String = "2";
		static private var STATE_CHECKED:String = "1";
		static private var STATE_UNCHECKED:String = "0";
		...
		private function marcaPadre():void
		{
			if(super.data){
				var myListData:TreeListData = TreeListData(this.listData);
				var selectedNode:Object = myListData.item;
				var tree:Tree = Tree(myListData.owner);
				toggleParents (selectedNode, tree, getState (tree, selectedNode));
			}
		}
		...
		override public function set data(value:Object):void{
			...
			if(TreeListData(super.listData).item.@type == 'S' ||
			   TreeListData(super.listData).item.@type == 'P')
			{
	   ...
	   override protected function updateDisplayList(unscaledWidth:Number, unscaledHeight:Number):void
	   {
	        ...
	        if(super.data)
	        {
	        	...
	        	if(data.@type == 'N' || data.@type == 'P'){
	        		myCheckBox.visible = true;
	        		if(data.@type == 'P')
	        			marcaPadre();
	        	}
	        		
			    if(myCheckBox.visible){
				    if (super.icon != null)
				    {
